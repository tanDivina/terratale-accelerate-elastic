...
export default function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-[#e8f5f5]">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-[#e8f5f5]">
      ...
      <div className="border-t border-gray-200 p-4 bg-[#e8f5f5]">
