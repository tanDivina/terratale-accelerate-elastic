...
• Voice Chat with Mateo: A real-time, multilingual voice conversation experience using Gemini LIVE API (built in Google AI Studio and deployed with Google Cloud Run), enabling hands-free exploration perfect for visitors in the field.
